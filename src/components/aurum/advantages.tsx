                ...
                <div class="row">
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <p class="light">
                                The library has been designed in a way that figuring out what needs to be rendered is almost free, giving you massive
                                performance without without sacrifycing power.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <p class="light">Aurum.js has few concepts and a small API, you can get a full understanding of Aurum.js in record time.</p>
                        </div>
                    </div>

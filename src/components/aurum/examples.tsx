...
const tabContent = new DataSource(<span>hello Tab 1</span>);
    ...
    },
    {
        ...
        description:
            'Aurum supports rendering async content. It will simply wait for the promise to resolve and render the resolved value. You can use the Suspense component to render temporary content while waiting for a promise.',

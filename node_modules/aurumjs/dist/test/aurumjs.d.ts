declare module "src/utilities/cancellation_token" {
    import { Delegate, Callback } from "src/utilities/common";
...
declare module "src/utilities/event_emitter" {
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { Callback } from "src/utilities/common";
    /**
     * @internal
     */
    ...
    export class EventEmitter<T> {
         ...
         */
        subscribeOnce(callback: import("src/utilities/common").Callback<T>, cancellationToken?: CancellationToken): EventSubscriptionFacade;
        /**
...
declare module "src/stream/operator_model" {
...
declare module "src/stream/stream" {
    import { DataSourceOperator } from "src/stream/operator_model";
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { Callback } from "src/utilities/common";
    import { DataSource, ReadOnlyDataSource } from "src/stream/data_source";
    /**
...
declare module "src/stream/data_source_operators" {
    import { ThenArg, Callback } from "src/utilities/common";
    ...
    import { DataSourceMapOperator, DataSourceFilterOperator, DataSourceMapDelayOperator, DataSourceMapDelayFilterOperator, DataSourceDelayOperator, DataSourceDelayFilterOperator, DataSourceNoopOperator } from "src/stream/operator_model";
    import { CancellationToken } from "src/utilities/cancellation_token";
    /**
     * Mutates an update
     */
...
declare module "src/stream/duplex_data_source_operators" {
    import { DuplexDataSourceDelayFilterOperator, DuplexDataSourceFilterOperator, DuplexDataSourceMapOperator } from "src/stream/operator_model";
...
declare module "src/stream/duplex_data_source" {
    import { AurumServerInfo } from "src/aurum_server/aurum_server_client";
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { Callback } from "src/utilities/common";
    import { EventEmitter } from "src/utilities/event_emitter";
    import { DataSource, GenericDataSource, ReadOnlyDataSource } from "src/stream/data_source";
    import { DataFlow } from "src/stream/duplex_data_source_operators";
    import { DataSourceOperator, DuplexDataSourceOperator } from "src/stream/operator_model";
    /**
...
declare module "src/stream/object_data_source" {
    import { AurumServerInfo } from "src/aurum_server/aurum_server_client";
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { Callback } from "src/utilities/common";
    import { ArrayDataSource, DataSource, ReadOnlyArrayDataSource, ReadOnlyDataSource } from "src/stream/data_source";
    import { DuplexDataSource } from "src/stream/duplex_data_source";
...
declare module "src/aurum_server/aurum_server_client" {
    import { ArrayDataSource, DataSource, MapDataSource, SetDataSource } from "src/stream/data_source";
    import { DuplexDataSource } from "src/stream/duplex_data_source";
...
declare module "src/stream/data_source" {
    import { AurumServerInfo } from "src/aurum_server/aurum_server_client";
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { Callback, Predicate } from "src/utilities/common";
    import { EventEmitter } from "src/utilities/event_emitter";
    import { DuplexDataSource } from "src/stream/duplex_data_source";
    import { DataSourceOperator } from "src/stream/operator_model";
...
declare module "src/utilities/common" {
    import { DataSource, ReadOnlyDataSource } from "src/stream/data_source";
    import { DuplexDataSource } from "src/stream/duplex_data_source";
...
declare module "src/utilities/classname" {
    import { ReadOnlyDataSource } from "src/stream/data_source";
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { AttributeValue, ClassType } from "src/utilities/common";
...
declare module "src/rendering/aurum_element" {
    import { DataSource, ArrayDataSource, ReadOnlyDataSource, ReadOnlyArrayDataSource } from "src/stream/data_source";
    import { DuplexDataSource } from "src/stream/duplex_data_source";
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { EventEmitter } from "src/utilities/event_emitter";
...
declare module "src/builtin_components/dom_adapter" {
    import { ClassType, DataDrain, Callback, MapLike, AttributeValue } from "src/utilities/common";
    import { Renderable, AurumComponentAPI } from "src/rendering/aurum_element";
    import { CancellationToken } from "src/utilities/cancellation_token";
...
declare module "src/nodes/input" {
    import { HTMLNodeProps } from "src/builtin_components/dom_adapter";
    import { AttributeValue, DataDrain } from "src/utilities/common";
    import { GenericDataSource } from "src/stream/data_source";
     ...
     * @internal
     */
    export const Input: (props: InputProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
}
declare module "src/nodes/select" {
    import { GenericDataSource } from "src/stream/data_source";
    import { HTMLNodeProps } from "src/builtin_components/dom_adapter";
     ...
     * @internal
     */
    export const Select: (props: SelectProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
}
declare module "src/nodes/simple_dom_nodes" {
    import { HTMLNodeProps } from "src/builtin_components/dom_adapter";
    import { AttributeValue, DataDrain } from "src/utilities/common";
    /**
     * @internal
     */
    export const Code: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Div: (props: HTMLNodeProps<HTMLDivElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const A: (props: AProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Abbr: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Address: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const H1: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const H2: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const H3: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const H4: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const H5: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const H6: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Area: (props: AreaProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Article: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Aside: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Span: (props: HTMLNodeProps<HTMLSpanElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const NoScript: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Video: (props: VideoProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Ul: (props: HTMLNodeProps<HTMLUListElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Ol: (props: HTMLNodeProps<HTMLOListElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Li: (props: HTMLNodeProps<HTMLLIElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const B: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Body: (props: HTMLNodeProps<HTMLBodyElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Title: (props: HTMLNodeProps<HTMLTitleElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Summary: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const THead: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Template: (props: HTMLNodeProps<HTMLTemplateElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Q: (props: HTMLNodeProps<HTMLQuoteElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Pre: (props: HTMLNodeProps<HTMLPreElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const P: (props: HTMLNodeProps<HTMLParagraphElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Hr: (props: HTMLNodeProps<HTMLHRElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Audio: (props: AudioProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Br: (props: HTMLNodeProps<HTMLBRElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Button: (props: ButtonProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Canvas: (props: CanvasProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Data: (props: DataProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Details: (props: HTMLNodeProps<HTMLDetailsElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Em: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Footer: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Form: (props: FormProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Meta: (props: MetaProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Html: (props: HtmlProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Head: (props: HTMLNodeProps<HTMLHeadElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Header: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Heading: (props: HTMLNodeProps<HTMLHeadingElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const I: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const IFrame: (props: IFrameProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Img: (props: ImgProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Label: (props: LabelProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Link: (props: LinkProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Nav: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Sub: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Sup: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Table: (props: HTMLNodeProps<HTMLTableElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const TBody: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const TFoot: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Col: (props: ColProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Colgroup: (props: HTMLNodeProps<HTMLTableColElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Caption: (props: HTMLNodeProps<HTMLTableCaptionElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Tr: (props: HTMLNodeProps<HTMLTableRowElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Td: (props: TableCellProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Th: (props: HTMLNodeProps<HTMLTableHeaderCellElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Time: (props: TimeProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Style: (props: StyleProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Source: (props: SourceProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Track: (props: TrackProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Param: (props: ParamProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Script: (props: ScriptProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Svg: (props: SvgProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Progress: (props: ProgressProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Option: (props: OptionProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const OptGroup: (props: OptGroupProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Slot: (props: SlotProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Strong: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Samp: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Kbd: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Var: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Wbr: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
    export const Picture: (props: HTMLNodeProps<HTMLElement>, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Output: (props: OutputProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
    /**
     * @internal
     */
     ...
     * @internal
     */
    export const Object: (props: ObjectProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
}
declare module "src/nodes/textarea" {
    import { GenericDataSource } from "src/stream/data_source";
    import { AttributeValue, DataDrain } from "src/utilities/common";
    import { HTMLNodeProps } from "src/builtin_components/dom_adapter";
     ...
     * @internal
     */
    export const TextArea: (props: TextAreaProps, children: import("src/aurumjs").Renderable[], api: import("src/aurumjs").AurumComponentAPI) => HTMLElement;
}
declare module "src/utilities/aurum" {
    import { HTMLNodeProps } from "src/builtin_components/dom_adapter";
    import { InputProps } from "src/nodes/input";
    import { SelectProps } from "src/nodes/select";
    import { AProps, AreaProps, AudioProps, ButtonProps, CanvasProps, ColProps, DataProps, FormProps, HtmlProps, IFrameProps, ImgProps, LabelProps, LinkProps, MetaProps, ObjectProps, OptGroupProps, OptionProps, OutputProps, ParamProps, ProgressProps, ScriptProps, SlotProps, SourceProps, StyleProps, SvgProps, TableCellProps, TimeProps, TrackProps, VideoProps } from "src/nodes/simple_dom_nodes";
    import { TextAreaProps } from "src/nodes/textarea";
    import { AurumComponentAPI, AurumElementModel, Renderable } from "src/rendering/aurum_element";
    import { ReadOnlyArrayDataSource, ReadOnlyDataSource } from "src/stream/data_source";
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { MapLike } from "src/utilities/common";
    export class Aurum {
...
declare module "src/rendering/webcomponent" {
    import { AurumComponentAPI, Renderable } from "src/rendering/aurum_element";
...
declare module "src/rendering/aurum_style" {
...
declare module "src/builtin_components/router" {
    import { AurumComponentAPI, Renderable } from "src/rendering/aurum_element";
    import { DataSource } from "src/stream/data_source";
...
declare module "src/builtin_components/suspense" {
    import { AurumComponentAPI, Renderable } from "src/rendering/aurum_element";
...
declare module "src/builtin_components/error_boundary" {
    import { AurumComponentAPI, Renderable } from "src/rendering/aurum_element";
    import { DataSource } from "src/stream/data_source";
...
declare module "src/builtin_components/switch" {
    import { AurumComponentAPI, Renderable } from "src/rendering/aurum_element";
    import { ReadOnlyDataSource } from "src/stream/data_source";
    export interface SwitchProps<T = boolean> {
        state: ReadOnlyDataSource<T>;
    }
    export function Switch<T = boolean>(props: SwitchProps<T>, children: Renderable[], api: AurumComponentAPI): import("src/stream/data_source").DataSource<Renderable[]>;
...
declare module "src/utilities/sources" {
    import { ObjectDataSource } from "src/aurumjs";
    import { DataSource, ArrayDataSource } from "src/stream/data_source";
    import { DuplexDataSource } from "src/stream/duplex_data_source";
    import { Stream } from "src/stream/stream";
...
declare module "src/stream/tree_data_source" {
    import { CancellationToken } from "src/utilities/cancellation_token";
    import { Callback } from "src/utilities/common";
    import { ArrayDataSource, ReadOnlyArrayDataSource } from "src/stream/data_source";
...
declare module "src/stream/emitters" {
    import { DataSource, ArrayDataSource } from "src/stream/data_source";
    import { Stream } from "src/stream/stream";
    import { DuplexDataSource } from "src/stream/duplex_data_source";
    import { CancellationToken } from "src/utilities/cancellation_token";
...
declare module "src/nodes/string_adapter" {
    ...
    export function aurumToString(content: any, config?: AurumStringAdapterConfig): Promise<string>;
}
declare module "src/utilities/transclusion" {
    import { Renderable } from "src/rendering/aurum_element";
    import { ReadOnlyArrayDataSource } from "src/stream/data_source";
    import { CancellationToken } from "src/utilities/cancellation_token";
...
declare module "src/aurumjs" {
    export * from "src/rendering/webcomponent";
    export { Renderable, SingularAurumElement, ArrayAurumElement, AurumComponentAPI, ComponentLifeCycle, createAPI, createLifeCycle, createRenderSession, RenderSession, AurumElement, aurumElementModelIdentitiy, AurumElementModel } from "src/rendering/aurum_element";
    export { AProps, ProgressProps, ColProps, ImgProps, SvgProps, AreaProps, DataProps, FormProps, HtmlProps, LinkProps, MetaProps, SlotProps, TimeProps, ParamProps, AudioProps, LabelProps, StyleProps, TrackProps, VideoProps, ButtonProps, CanvasProps, IFrameProps, ObjectProps, OptionProps, OutputProps, ScriptProps, SourceProps, OptGroupProps, TableCellProps } from "src/nodes/simple_dom_nodes";
    export { InputProps } from "src/nodes/input";
    export { SelectProps } from "src/nodes/select";
    export { TextAreaProps } from "src/nodes/textarea";
    export * from "src/rendering/aurum_style";
    export * from "src/builtin_components/router";
    export * from "src/builtin_components/suspense";
    export * from "src/builtin_components/error_boundary";
    export * from "src/builtin_components/switch";
    export * from "src/stream/data_source";
    export * from "src/stream/duplex_data_source";
    export * from "src/stream/object_data_source";
    export * from "src/stream/tree_data_source";
    export * from "src/stream/data_source_operators";
    export * from "src/stream/duplex_data_source_operators";
    export * from "src/stream/operator_model";
    export * from "src/stream/stream";
    export * from "src/utilities/aurum";
    export * from "src/utilities/cancellation_token";
    export * from "src/utilities/event_emitter";
    export * from "src/utilities/classname";
    export * from "src/utilities/sources";
    export * from "src/stream/emitters";
    export * from "src/nodes/string_adapter";
    export * from "src/utilities/transclusion";
    export { aurumToHTML } from "src/builtin_components/dom_adapter";
    export { debugMode, enableDebugMode, enableDiagnosticMode } from "src/debug_mode";
    export { AttributeValue, ClassType, DataDrain } from "src/utilities/common";
    export { RemoteProtocol, getRemoteFunction } from "src/aurum_server/aurum_server_client";
}
declare module "test/cancellation_token.test" { }
declare module "test/test_utils" {
    import { CancellationToken, Renderable } from "src/aurumjs";
    export function sleep(time: any): Promise<void>;
    export function getTestRoot(): HTMLElement;
    export function attachToTestRoot(component: Renderable): CancellationToken;
}
declare module "test/data_sources/utils" { }
declare module "test/data_sources/array_data_source.test" { }
declare module "test/data_sources/datasource.test" { }
declare module "test/data_sources/object_data_source.test" { }
declare module "test/data_sources/tree_data_source.test" { }
declare module "test/internal_components/suspense.test" {
    import { Renderable } from "src/rendering/aurum_element";
    export function generateSuspenseTests(renderSuspense: (fallback?: Renderable, children?: any) => Renderable): void;
}
declare module "test/internal_components/error_boundary.test" { }
declare module "test/internal_components/node.test" { }
declare module "test/internal_components/router.test" { }
declare module "test/internal_components/select.test" { }
declare module "test/internal_components/switch.test" { }
declare module "test/rendering/aurum.test" { }
declare module "test/rendering/aurum_element.test" { }
declare module "test/rendering/aurum_to_html.test" { }
declare module "test/rendering/components.test" { }
